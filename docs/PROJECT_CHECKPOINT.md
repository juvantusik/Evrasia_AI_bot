...
3. real SMS ownership test for USER_ID 880339 is **PASSED**; next inspect/use the exact native Bitrix pending-enrollment flow, then guarded QR/TOTP activation + session revocation + optional/non-mandatory global OTP enablement and login E2E;
